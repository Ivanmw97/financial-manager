  ...
  <form class="space-y-5" @submit.prevent="handleSignIn">
    ...
    <div>
      ...
      <div class="relative">
        ...
        >
          <svg v-if="showPassword" xmlns="http://www.w3.org/2000/svg" class="w-4 h-4" viewBox="0 0 20 20" fill="currentColor">
    ...
    <div class="flex items-center justify-between">
      <label class="flex items-center gap-2 cursor-pointer">
        <input
          ...
          v-model="rememberMe"
          type="checkbox"
          class="w-4 h-4 text-blue-500 bg-gray-700 border-gray-500 rounded focus:ring-blue-500 focus:ring-offset-gray-800"
        />
    ...
    <div class="relative">
      ...
      <div class="relative flex justify-center text-xs">
        <span class="px-3 text-gray-500 bg-gray-800">or continue with</span>
      </div>
    </div>
    ...
    <div class="grid grid-cols-2 gap-3">
      <button
        ...
        @click.prevent="emit('social-sign-in', 'google')"
      >
    ...
    <!-- Guest mode warning -->
    <div class="flex items-start gap-2 p-3 bg-opacity-50 border border-opacity-50 bg-amber-950 border-amber-800 rounded-xl">
